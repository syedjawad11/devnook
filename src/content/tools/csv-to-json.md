---
category: tools
description: Convert CSV data to JSON and JSON arrays back to CSV instantly in your
  browser. Supports custom delimiters, headers, and pretty output.
og_image: /og/tools/csv-to-json.png
published_date: '2026-04-13'
related_content:
- csv-vs-json
- parsing-csv-javascript
related_tools:
- json-formatter
- markdown-to-html
tags:
...
1. **Select conversion direction**: Choose CSV to JSON or JSON to CSV from the mode selector
2. **Paste your data**: Insert CSV data or a JSON array into the input textarea
3. **Configure options**: Set delimiter type, toggle header row treatment, and choose output formatting (pretty or minified)
4. **Convert**: Click the Convert button to process your data instantly
5. **Copy result**: Use the Copy to Clipboard button to grab the converted output
