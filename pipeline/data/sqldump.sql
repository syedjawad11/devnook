CREATE TABLE cheatsheet_rewrite_queue (
  ...
  queue_order INTEGER DEFAULT 99,
  rewrite_status TEXT NOT NULL DEFAULT 'queued',
  notes TEXT,
...
CREATE TABLE language_rewrite_queue (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  post_id INTEGER NOT NULL, slug TEXT NOT NULL, language TEXT NOT NULL, concept TEXT NOT NULL,
  title TEXT, primary_keyword TEXT, keywords_json TEXT,
  old_word_count INTEGER, target_word_count INTEGER DEFAULT 1800,
  queue_order INTEGER, rewrite_status TEXT DEFAULT 'queued', notes TEXT,
  created_at TEXT DEFAULT (datetime('now')), rewritten_at TEXT );
